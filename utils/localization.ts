...
export const translations = {
  sv: {
    ...
    loginTitle: 'Vem är du?',
    loginNameLabel: 'Användarnamn',
    loginPasswordLabel: 'Lösenord',
    loginButton: 'Öppna dörren',
    logoutButton: 'Logga ut',
    loginError: 'Du måste logga in för att skapa sagor!',
    loginInvalidCredentials: 'Fel användarnamn eller lösenord. Försök igen!',
    loginPlaceholder: 'Skriv ditt namn...',
    passwordPlaceholder: 'Hemligt lösenord...',
    welcomeUser: 'Hej',
    moods: {
      [Mood.HAPPY]: 'Glad',
  ...
  en: {
    ...
    loginButton: 'Open the Door',
    logoutButton: 'Log out',
    loginError: 'You must be logged in to create stories!',
    loginInvalidCredentials: 'Wrong username or password. Try again!',
    loginPlaceholder: 'Type your name...',
